...
class Actor(nn.Module):
	...
	def __init__(self, state_dim, action_dim, action_lim):
		...
		self.fc0 = nn.Linear(state_dim,2048)
	...
	def forward(self, state,min_action,gap_action):
		...
		action_b = F.sigmoid(self.fc4(x))
		#print('action begin is ',action)
		#print('self.action_lim is ',self.action_lim)
		...
		if(action_b.size()[0] >1):       
		  ...
		  action_v=min_v+action_b[0][54:108]*min_v
		#action_v=min_v+action_b[54:108]*min_v
